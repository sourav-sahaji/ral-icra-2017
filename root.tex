...
% The validity of our proposed approach is also confirmed with the fact that the value of average neighborhood normalization zone width ($\bar{R'}$) across a dataset lies approximately at the point where arbitrarily chosen neighborhood by vanilla SeqSLAM attains its peak performance.
...
%  
%  \multicolumn{6}{c}{(a) Ground Truth} \\
% 
...
% 
%  \multicolumn{6}{c}{(b) Vanilla SeqSLAM} \\
%  
...
% 
%  \multicolumn{6}{c}{(c) Proposed Method} \\
